...
public class Client extends Application {
    ...
    private String currentCheckoutName= null;
...
//        applicationStage.initStyle(StageStyle.UNDECORATED);
                                    ...
                                    if (itemFromServer.getItemType().equals("Book")) {
                                        for (Item i : books) {
                                            if (i.getName().equals(itemFromServer.getName())) {
                                                ...
                                                i.setHolders(itemFromServer.getHolders());
                                                i.setPrevious(itemFromServer.getPrevious());
                                                i.setPreviousDates(itemFromServer.getPreviousDates());
                                                if(holdController != null) holdController.refreshTable(itemFromServer);
                                                if(checkoutController != null) checkoutController.refreshTable(itemFromServer);
    ...
    public String getCurrentCheckoutName() {
        return currentCheckoutName;
    }

    public void setCurrentCheckoutName(String currentCheckoutName) {
        this.currentCheckoutName = currentCheckoutName;
    }
}